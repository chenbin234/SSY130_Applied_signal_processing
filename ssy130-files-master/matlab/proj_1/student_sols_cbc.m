...
% directory as this file as well as any of the standard matlab functions.
    ...
    function symb = bits2qpsk(bits)
        ...
        symb = (bits(1:2:end)+bits(2:2:end)*j)/sqrt(2); %TODO: This line is missing some code!
    end 
    ...
    function [rx, evm, ber, symbs, x, z, zcp, ycp] = sim_ofdm_known_channel(tx, h, N_cp, snr, sync_err)
